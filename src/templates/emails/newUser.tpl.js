                                 ...
                                 >
                                    ...
                                    <tr>
                                       <td>
                                          ...
                                          <hr>
                                          <p style="font-size: 1.3rem; font-weight: 600;">Registro generado,</p>
                                          
                                          <p>
                                             Uds. <strong>${nameUser}</strong>, ha sido registrado con éxito en el sistema de la Parroquia Santa María Madre.
                                          </p>

                                          <p style="margin-left: 50px;"><strong>Su contraseña es: </strong> ${passNew}</p>

                                          <p>Para mayor seguridad deberá de cambiarla una ves iniciada sesión</p>

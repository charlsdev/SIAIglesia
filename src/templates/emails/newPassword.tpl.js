                                    ...
                                    >
                                       ...
                                       <tr>
                                          <td>
                                             ...
                                             <hr>
                                             <p style="font-size: 1.3rem; font-weight: 600;">Contraseña generada,</p>

                                             <p>
                                                Uds. <strong>${nameUser}</strong>, ha solicitado la generación de una nueva contraseña. Su requerimiento ha sido atentido y para mayor seguridad deberá de cambiarla una ves iniciada sesión.
                                             </p>

                                             <p style="margin-left: 50px;"><strong>Nueva contraseña: </strong> ${passNew}</p>

                                             <p>En caso de no haber solicitado este requerimiento trate de comunicarse con el administrador del sistema.</p>
